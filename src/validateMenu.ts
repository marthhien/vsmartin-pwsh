...
export class ValidateMenuProvider implements vscode.TreeDataProvider<ValidateMenu> {
    ...
    private _onDidChangeTreeData: vscode.EventEmitter<ValidateMenu | undefined | void> = new vscode.EventEmitter<ValidateMenu | undefined | void>();
    readonly onDidChangeTreeData: vscode.Event<ValidateMenu | undefined | void> = this._onDidChangeTreeData.event;
